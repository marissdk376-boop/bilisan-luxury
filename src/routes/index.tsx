      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <div className="mb-5 sm:mb-6">
            <h2 className="mb-3 text-center text-2xl sm:text-4xl font-black leading-snug drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]" style={{color: "#1a5c2a"}}>عشبة العلندة الخضراء لمعالجة ومقاومة الاورام الخبيثة</h2>
